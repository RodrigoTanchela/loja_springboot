...
import com.rodrigo.loja.springboot.service.AuthServices;
...
@RestController
@RequestMapping("/auth")
@Tag(name = "Usuario", description = "Endpoints for Managing Usuario")
	...
	public ResponseEntity signin(@RequestBody AccountCredentialsVO data) {
		try {
			if(checkParametersNull(data)) {
				ResponseEntity.status(HttpStatus.FORBIDDEN).body("Invalid usuario request");
			}
